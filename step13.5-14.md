...
iterations
latency_ms
这样以后你可以回答面试官一个很生产化的问题：

“如果 Agent 的 LLM grader 挂了，你怎么知道？”
...
“Policy 会显式记录 fallback source 和 error type；我单独监控 grader fallback rate、model timeout rate 和 route distribution，防止能力静默退化。”
​
